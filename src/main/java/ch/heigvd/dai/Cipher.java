...
public class Cipher {
    ...
    private static javax.crypto.Cipher initPBECipher(String password, int opmode, IvParameterSpec ivParameterSpec)
            throws GeneralSecurityException {
        PBEParameterSpec pbeParameterSpec = new PBEParameterSpec(SALT, 100_000, ivParameterSpec);
        PBEKeySpec pbeKeySpec = new PBEKeySpec(password.toCharArray());
        Key key = SecretKeyFactory.getInstance("PBEWithHmacSHA256AndAES_128").generateSecret(pbeKeySpec);
    ...
    public static String decrypt(String content, String password) throws IllegalArgumentException, GeneralSecurityException {
        ...
        javax.crypto.Cipher cipher = initPBECipher(password, javax.crypto.Cipher.DECRYPT_MODE, ivParameterSpec);
    ...
    public static String encrypt(String content, String password) throws GeneralSecurityException {
        ...
        IvParameterSpec ivParameterSpec = new IvParameterSpec(iv);
        javax.crypto.Cipher cipher = initPBECipher(password, javax.crypto.Cipher.ENCRYPT_MODE, ivParameterSpec);
